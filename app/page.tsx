    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="flex flex-col items-center justify-center text-center px-8 py-32">
        ...
        <div className="flex gap-4 mt-10">
          <button className="bg-blue-800 text-white px-6 py-3 rounded-lg font-medium">
            Démarrer gratuitement
          </button>
          <button className="border border-slate-200 text-slate-700 px-6 py-3 rounded-lg font-medium">
            Voir la démo
          </button>
        </div>
      </section>
