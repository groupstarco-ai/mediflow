    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 px-8 py-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 max-w-2xl">
          <h1 className="text-xl font-bold text-slate-900 mb-2">Créer un dossier patient</h1>
          <p className="text-slate-500 text-sm mb-6">Informations administratives — remplies par le gestionnaire</p>
